...
package com.damon1974.infowatchface.phone.databinding;
...
import com.damon1974.infowatchface.phone.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnLogout, @NonNull Button btnRefresh, @NonNull TextView tvSession,
      @NonNull TextView tvStatus, @NonNull TextView tvWeekly) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, btnLogin, btnLogout, btnRefresh,
          tvSession, tvStatus, tvWeekly);
    }
